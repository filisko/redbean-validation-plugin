...
class ModelValidation implements \RedBeanPHP\Plugin
{
    public static function validate(\RedBeanPHP\OODBBean $bean)
    {
        ...
        if ( ! $model )
        {
            throw new BeanModelValidationPlugin_Exception('This bean does not have a model!');
        }
        ...
        if ( ! $rules )
        {
            throw new BeanModelValidationPlugin_Exception('This bean does not have any established rules!');
        }
...
class BeanModelValidationPlugin_Exception extends \Exception {}